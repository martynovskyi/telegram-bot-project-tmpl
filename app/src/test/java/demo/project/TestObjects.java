...
public final class TestObjects {
    ...
    public static BotContext context(Bot bot) {
        return new BotContext("unit_test", bot);
    }
    ...
    public static Message command(Command command) {
        Message message = new Message();
        message.setChat(TestObjects.chat());
        message.setFrom(TestObjects.user());
        message.setText(command.getCommand());
        return message;
    }
